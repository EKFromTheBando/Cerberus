...
namespace Cerberus.Cerberus.Helpers
{
    ...
    public class EndianReader : BinaryReader
    {
        ...
        public virtual uint ReadUInt24(EndianTypes EndianType)
        {
            ...
            return (uint)(array[2] << 16) | (uint)(array[1] << 8) | array[0];
        }
        ...
        public virtual ulong ReadUInt40(EndianTypes EndianType)
        {
            ...
            return ((ulong)array[4] << 32) | ((ulong)array[3] << 24) | ((ulong)array[2] << 16) | ((ulong)array[1] << 8) | array[0];
        }
        ...
        public virtual ulong ReadUInt48(EndianTypes EndianType)
        {
            ...
            return ((ulong)array[5] << 40) | ((ulong)array[4] << 32) | ((ulong)array[3] << 24) | ((ulong)array[2] << 16) | ((ulong)array[1] << 8) | array[0];
        }
        ...
        public virtual ulong ReadUInt56(EndianTypes EndianType)
        {
            ...
            return ((ulong)array[6] << 48) | ((ulong)array[5] << 40) | ((ulong)array[4] << 32) | ((ulong)array[3] << 24) | ((ulong)array[2] << 16) | ((ulong)array[1] << 8) | array[0];
        }
